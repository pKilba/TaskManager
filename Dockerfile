...
WORKDIR /testApp
COPY /entity/target/entity-1.0-SNAPSHOT.jar ./entity-1.0-SNAPSHOT.jar
COPY /logic/target/logic-1.0-SNAPSHOT.war ./logic-1.0-SNAPSHOT.war

CMD ["java", "-jar", "logic-1.0-SNAPSHOT.war"]
